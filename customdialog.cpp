...
CustomDialog::CustomDialog(AbstractFrameImplementable *implementable,
                           bool applicationModal,
                           widget_Location location, QWidget *parent) :
    QWidget(parent),
...
{
    QString style = implementable->styleSheet();
    ...
    widgetGridLayout->itemAtPosition(0,0)->widget()->setStyleSheet(style);
}
